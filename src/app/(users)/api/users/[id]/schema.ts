...
export const PublicUserDetailResponseSchema = DataResponseSchema(PublicUserDetailSchema);

export type PublicUserDetailResponse = z.infer<typeof PublicUserDetailResponseSchema>;

export const UpdateUserRequestSchema = z.object({
  name: z.string().min(1, '이름은 필수입니다').max(20, '이름은 20자 이하여야 합니다'),
