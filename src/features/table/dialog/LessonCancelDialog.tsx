...
export default function LessonCancelDialog({
  ...
  const { update: cancelLesson, isSaving: isCancelling } = useUpdate<{}, CancelLessonResponse>();
  ...
  return (
    <Box p={4} border="1px solid" borderColor="orange.200" bg="orange.50" borderRadius="md">
