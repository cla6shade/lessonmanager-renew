...
export default function TeacherTable() {
  const { page, setPage, teachers, total, totalPages, isTeacherLoading, refetchTeachers } =
                ...
                <Table.Row key={teacher.id}>
                  ...
                  <Table.Cell>
                    {teacher.reregisterFraction[1] > 0
                      ? `${Math.round(
                          (teacher.reregisterFraction[0] / teacher.reregisterFraction[1]) * 100,
                        )}% (${teacher.reregisterFraction[0]} / ${teacher.reregisterFraction[1]})`
                      : '-'}
                  </Table.Cell>
                  <Table.Cell>
                  ...
                  <Table.Cell width="100px" display="flex" justifyContent="center">
                    <HStack gap={2}>
                      <Button size="sm" variant="outline" onClick={() => openDetailDialog(teacher)}>
                        상세 보기
                      </Button>
                    </HStack>
                  </Table.Cell>
