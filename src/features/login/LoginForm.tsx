  ...
  return (
    ...
    >
      <form action={formAction} style={{ flexGrow: 1 }}>
        <Flex direction="column" justify="center" align="center" w="full" h="full" px={10} gap={2}>
          <Box
            ...
            gap={2}
          >
            <Image src={brand.logo.src} alt={brand.name} width={200} height={80} />
          ...
          <Flex w="full" alignItems="center" gap={2}>
            <input type="checkbox" id="isAdmin" name="isAdmin" value="true" disabled={pending} />
            <label htmlFor="isAdmin">
              <Text color={{ base: 'white', lg: 'gray.800' }} fontSize="sm" cursor="pointer">
                관리자 로그인
              </Text>
            </label>
          </Flex>
